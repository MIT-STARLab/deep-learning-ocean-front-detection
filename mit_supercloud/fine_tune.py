...
NAME_OF_MODEL = 'cedn_small_human.h5'
ARCHITECTURE = CEDN_small()
MODEL_WEIGHTS = 'Trained Models/cedn_small_boa.h5'

#load model with boa weights, compile
model = ARCHITECTURE
...
X = np.load('data/human_training_input.npy')
Y = np.load('data/human_training_output.npy')
